...
public class UserJourneyTestIT {
  ...
  public static void tearDownClass() {
    ...
    if (!LOCAL_TEST) {
      ...
      StructuredQuery<Key> query = Query.newKeyQueryBuilder().setKind("Book4").build();
  ...
  private void checkReadPage(
      String title, String author, String datePublished, String description, String addedBy)
      throws Exception {
